    ...
    <main className="container m-auto bg-black text-white py-20 px-4 flex items-center justify-center gap-10">
      <div className="grid gap-10 basis-1/3">
        ...
        <div className="flex items-center gap-5">
          {
            timing.map((time)=>(
          <div key={time.label}  className="h-20 w-20 bg-white text-black rounded-full flex items-center justify-center">
        ...
        <Button variant={"default"} size={"lg"} className="bg-green-500 rounded w-fit px-10 py-6">
          Buy Now
        </Button>
      </div>
